...
class COMTVertex : public CVertex
{
  ...
  public:
    ...
    CPoint &dual_center()
    {
        return m_dual_center;
    };

    /*! update direction */
    double &update_direction()
    {
        return m_update_direction;
    };
 ...
 *
 */
template <typename V, typename E, typename F, typename H> class COMTDynamicMesh : public CDynamicMesh<V, E, F, H>
{
  public:
    typedef V CVertex;
    typedef E CEdge;
