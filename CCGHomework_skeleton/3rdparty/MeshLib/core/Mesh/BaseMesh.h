...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CFace *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeFace(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::faceHalfedge(tFace f) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeNext(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgePrev(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeSym(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeEdge(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CVertex *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeVertex(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CVertex *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeTarget(tHalfEdge he) {
  return (CVertex *)he->vertex();
};
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CVertex *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::halfedgeSource(tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline bool
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::isBoundary(tHalfEdge he) {
  if (he->he_sym() == NULL)
    return true;
  return false;
};
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexMostClwOutHalfEdge(
    tVertex v) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexMostCcwOutHalfEdge(
    tVertex v) {
...
/*!
    ...
    */
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::corner(tVertex v,
                                                                      tFace f) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexNextCcwOutHalfEdge(
    tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexNextClwOutHalfEdge(
    tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexMostClwInHalfEdge(
    tVertex v) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexMostCcwInHalfEdge(
    tVertex v) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexNextCcwInHalfEdge(
    tHalfEdge he) {
  assert(he->he_sym() != NULL);
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexNextClwInHalfEdge(
    tHalfEdge he) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::faceNextClwHalfEdge(tHalfEdge he) {
  return (CHalfEdge *)he->he_prev();
};
/*!
    The next Ccw HalfEdge of a halfedge in a face
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::faceNextCcwHalfEdge(tHalfEdge he) {
  return (CHalfEdge *)he->he_next();
};
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::faceMostCcwHalfEdge(tFace face) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::faceMostClwHalfEdge(tFace face) {
...
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::~CBaseMesh() {
  ...
  for (std::list<CVertex *>::iterator viter = m_verts.begin();
  ...
  for (std::list<CFace *>::iterator fiter = m_faces.begin();
    ...
    for (std::list<CHalfEdge *>::iterator hiter = hes.begin();
         hiter != hes.end(); hiter++) {
      CHalfEdge *pH = *hiter;
      delete pH;
    }
  ...
  // remove edges
  for (std::list<CEdge *>::iterator eiter = m_edges.begin();
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::read_obj(
    const char *filename) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
CFace *CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::createFace(tVertex v[],
                                                               int id) {
  CFace *f = new CFace();
  assert(f != NULL);
  f->id() = id;
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
CEdge *CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::createEdge(tVertex v1,
                                                               tVertex v2) {
  tVertex pV = (v1->id() < v2->id()) ? v1 : v2;
  std::list<CEdge *> &ledges = (std::list<CEdge *> &)pV->edges();

  for (std::list<CEdge *>::iterator te = ledges.begin(); te != ledges.end();
       te++) {
    CEdge *pE = *te;
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexEdge(tVertex v0,
                                                        tVertex v1) {
  CVertex *pV = (v0->id() < v1->id()) ? v0 : v1;
  std::list<CEdge *> &ledges = vertexEdges(pV);

  for (std::list<CEdge *>::iterator eiter = ledges.begin();
       eiter != ledges.end(); eiter++) {
    CEdge *pE = *eiter;
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexHalfedge(tVertex v0,
                                                            tVertex v1) {
...
// access vertex->edges
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline std::list<CEdge *> &
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexEdges(tVertex v0) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline CHalfEdge *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::vertexHalfedge(tVertex v) {
...
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::read_m(const char *input) {
  ...
  for (std::list<CEdge *>::iterator eiter = m_edges.begin();
    ...
    if (he[1] != NULL) {
      assert(he[0]->target() == he[1]->source() &&
             he[0]->source() == he[1]->target());
  ...
  for (std::list<CVertex *>::iterator viter = dangling_verts.begin();
...
/*!
    ...
    */
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::write_obj(
    const char *output) {
  std::fstream _os(output, std::fstream::out);
  if (_os.fail()) {
    fprintf(stderr, "Error is opening file %s\n", output);
...
/*!
    ...
    */
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::write_off(
    const char *output) {
  std::fstream _os(output, std::fstream::out);
  if (_os.fail()) {
    fprintf(stderr, "Error is opening file %s\n", output);
  ...
  _os << "OFF" << std::endl;
  _os << m_verts.size() << " " << m_faces.size() << " " << m_edges.size()
      << std::endl;
  ...
  for (std::list<CVertex *>::iterator viter = m_verts.begin();
       viter != m_verts.end(); viter++) {
    tVertex v = *viter;
    _os << v->point()[0] << " " << v->point()[1] << " " << v->point()[2]
        << std::endl;
...
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::deleteFace(tFace pFace) {
  ...
  // modified by Wei CHEN, 2018-2-13
    for
      each(auto pV in isolated_verts) {
...
template <typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
CFace *
CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::createFace(std::vector<tVertex> &v,
                                                        int id) {
  CFace *f = new CFace();
  assert(f != NULL);
  f->id() = id;
