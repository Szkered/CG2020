...
class CHodgeDecompositionVertex : public CVertex
{
  public:
    ...
    CHodgeDecompositionVertex()
        : m_index(0), m_form(0), m_rgb(229.0 / 255.0, 162.0 / 255.0, 141.0 / 255.0), m_touched(false), m_father(0){};
...
class CHodgeDecompositionHalfEdge : public CHalfEdge
{
  public:
    ...
    CHodgeDecompositionHalfEdge() : m_angle(0)
    {
        m_form = 0;
    };
 ...
 *
 */
template <typename V, typename E, typename F, typename H> class THodgeDecompositionMesh : public CBaseMesh<V, E, F, H>
{
  public:
    typedef V CVertex;
    typedef E CEdge;
...
typedef THodgeDecompositionMesh<CHodgeDecompositionVertex, CHodgeDecompositionEdge, CHodgeDecompositionFace,
                                CHodgeDecompositionHalfEdge>
    CHodgeDecompositionMesh;
} // namespace MeshLib
